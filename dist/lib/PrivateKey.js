...
class PrivateKey {
    ...
    multiply(pk, compressed = false) {
        return (0, utils_1.getSharedPoint)(this.data, pk.compressed, compressed);
    }
    /**
    ...
    validateSecret(secret) {
        return utils_1.K1.utils.isValidPrivateKey(secret);
    }
    /**
    ...
    getValidSecret() {
        let secret;
        do {
            secret = (0, utils_1.randomBytes)(config_2.SECRET_KEY_LENGTH);
     ...
     */
    getPublicKey(secret) {
        return utils_1.K1.getPublicKey(secret);
    }
}
