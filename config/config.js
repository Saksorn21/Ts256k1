...
exports.isSignatureOptsLowS = exports.signThrowMessage = exports.isEphemeralKeyCompressed = exports.isHkdfKeyCompressed = void 0;
...
class Config {
    ...
    constructor() {
        ...
        Object.defineProperty(this, "signThrowMessage", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "isSignatureOptsLowS", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
...
const signThrowMessage = () => TS256K1_CONFIG.signThrowMessage;
exports.signThrowMessage = signThrowMessage;
const isSignatureOptsLowS = () => TS256K1_CONFIG.isSignatureOptsLowS;
exports.isSignatureOptsLowS = isSignatureOptsLowS;
